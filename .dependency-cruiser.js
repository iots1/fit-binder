...
module.exports = {
    forbidden: [
        {
            ...
            comment: 'ห้ามแต่ละ Bounded Context import หากันโดยตรง',
            severity: 'error',
            from: { path: '^apps/([^/]+)/src' },
            to: {
                path: '^apps/([^/]+)/src',
                pathNot: '^apps/$1/src', // ห้ามไปแอปอื่นที่ชื่อไม่เหมือนตัวเอง
            },
        },
        {
            name: 'no-circular',
    ...
    options: {
        ...
        exclude: {
            path: [
                'node_modules',
                '^apps/docs', // ข้ามแอป docs ทั้งหมด
                '^dist', // ข้ามโฟลเดอร์ dist ที่ root
                '/dist/', // ข้ามทุกโฟลเดอร์ที่ชื่อ dist ใน sub-folders
                '\\.spec\\.ts$', // ข้ามไฟล์ test (ถ้าไม่อยากเช็คในกฎทั่วไป)
            ],
        },
...
// generated: dependency-cruiser@17.3.6 on 2026-01-17T15:14:03.468Z
